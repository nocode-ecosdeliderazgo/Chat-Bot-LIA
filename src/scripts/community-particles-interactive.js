// Sistema de partículas interactivas para community.html
document.addEventListener('DOMContentLoaded', function() {
    // console.log('🚀 Inicializando sistema de partículas para community.html');
...
function initDOMParticles(container) {
    ...
    function createFloatingParticle() {
        ...
        particle.className = 'floating-particle community-particle';
        ...
        particle.style.animation = `communityOrbitalMotion ${duration}s infinite linear ${delay}s`;
    ...
    setInterval(() => {
        const particles = container.querySelectorAll('.community-particle');
        particles.forEach(particle => {
...
style.textContent = `
    ...
    [data-theme="light"] .particle {
        background: rgba(68, 229, 255, 0.7);
    }
    ...
    @keyframes communityOrbitalMotion {
        0% {
