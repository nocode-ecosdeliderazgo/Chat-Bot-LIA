// Sistema de partículas interactivas para notices.html
document.addEventListener('DOMContentLoaded', function() {
    // console.log('🚀 Inicializando sistema de partículas para notices.html');
...
function initDOMParticles(container) {
    ...
    function createFloatingParticle() {
        ...
        particle.className = 'floating-particle notices-particle';
        ...
        particle.style.animation = `noticesOrbitalMotion ${duration}s infinite linear ${delay}s`;
    ...
    setInterval(() => {
        const particles = container.querySelectorAll('.notices-particle');
        particles.forEach(particle => {
...
style.textContent = `
    ...
    @keyframes noticesOrbitalMotion {
        0% {
