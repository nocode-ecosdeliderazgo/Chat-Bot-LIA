// Sistema de partículas directo para courses.html
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Inicializando sistema de partículas para courses.html');
...
function initDOMParticles(container) {
    ...
    function createFloatingParticle() {
        ...
        particle.className = 'floating-particle courses-particle';
        ...
        particle.style.animation = `coursesOrbitalMotion ${duration}s infinite linear ${delay}s`;
    ...
    setInterval(() => {
        const particles = container.querySelectorAll('.courses-particle');
        particles.forEach(particle => {
...
style.textContent = `
    ...
    @keyframes coursesOrbitalMotion {
        0% {
