// Sistema de partículas directo para profile.html
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Inicializando sistema de partículas para profile.html');
...
function initDOMParticles(container) {
    ...
    function createFloatingParticle() {
        ...
        particle.className = 'floating-particle profile-particle';
        ...
        particle.style.animation = `profileOrbitalMotion ${duration}s infinite linear ${delay}s`;
    ...
    setInterval(() => {
        const particles = container.querySelectorAll('.profile-particle');
        particles.forEach(particle => {
...
// Agregar estilos CSS dinámicamente específicos para profile
const style = document.createElement('style');
style.textContent = `
    @keyframes profileOrbitalMotion {
        0% {
...
console.log('✅ Estilos CSS específicos para profile agregados dinámicamente');
